...
const Card = ({ user }) => {
  return (
    <div className="relative transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300 shadow-md bg-white rounded-lg w-80 h-60 flex flex-col justify-between p-4 group">
